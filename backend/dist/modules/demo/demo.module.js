...
const demo_seeder_1 = require("./demo-seeder");
...
exports.DemoModule = DemoModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, deal_entity_1.Deal, deal_party_entity_1.DealParty, condition_entity_1.Condition])],
        providers: [demo_seeder_1.DemoSeeder],
    })
], DemoModule);

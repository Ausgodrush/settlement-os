...
export default function BuyNowModal({ listing, onClose }: Props) {
  ...
  const net   = parseFloat((price - fee).toFixed(2));
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 fade-in"
            ...
            <>
              ...
              {method === 'CRYPTO' && (
                <div className="mb-5 bg-gray-50 border border-gray-200 rounded-xl p-4">
                  <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Crypto payment</p>
                  <p className="text-sm text-gray-600">Connect your wallet or scan the QR code to pay with BTC, ETH, or SOL.</p>
                  <div className="mt-3 flex items-center justify-center h-20 bg-gray-100 rounded-lg text-gray-400 text-sm">
              ...
              <button
                ...
                className="w-full py-3.5 bg-gray-900 text-white text-sm font-bold rounded-xl hover:bg-black transition-colors flex items-center justify-center gap-2"
              >

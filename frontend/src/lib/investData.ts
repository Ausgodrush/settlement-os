...
export const MOCK_POOLS: InvestPool[] = [
  ...
  },
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1582761370596-77a6a42350d7?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    status: 'OPEN',
    currency: 'AUD',
    imageUrl: 'https://images.unsplash.com/photo-1505873242700-f289a29e1724?auto=format&fit=crop&w=1200&q=80',
    images: [
      'https://images.unsplash.com/photo-1505873242700-f289a29e1724?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    status: 'FUNDED',
    currency: 'AUD',
    imageUrl: 'https://images.unsplash.com/photo-1560185007-c5ca9d2c014d?auto=format&fit=crop&w=1200&q=80',
    images: [
      'https://images.unsplash.com/photo-1560185007-c5ca9d2c014d?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1759972268078-e51691a47301?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1600210492493-0946911123ea?auto=format&fit=crop&w=1200&q=80',
    ],
  ...
  },
  {
    id: 'p9',
    listingId: 'l9',
    name: 'Ubud Jungle Retreat Trust',
    location: 'Ubud, Bali',
    country: 'ID',
    flag: '🇮🇩',
    targetRaise: 395000,
    ...
    propertyType: '2BR Jungle Villa',
    beds: 2,
    baths: 2,
    landSize: '380m²',
    description: 'Intimate jungle villa with sweeping rice-terrace views in Ubud, Bali\'s cultural and wellness capital. Strong Airbnb performance with consistent 78%+ occupancy.',
    features: ['Rice terrace views', 'Private plunge pool', 'Yoga deck', 'Managed short-stay'],
  },
  {
    id: 'p10',
    listingId: 'l10',
